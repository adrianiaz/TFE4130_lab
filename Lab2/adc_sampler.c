...
/* RPi PIN ASSIGNMENTS */
#define MISO1 22    // ADC 1 MISO (GPIO pin number)
#define MISO2 23    // ADC 2 MISO (GPIO pin number)
#define MISO3 24    // ADC 3 MISO (GPIO pin number)
#define MISO4 25    // ADC 4 MISO (GPIO pin number)
#define MISO5 26    // ADC 5 MISO (GPIO pin number)
...
#define CLK 20      // GPIO for SPI clock (GPIO 16).
